...
# CDKTN prebuilt bindings for hashicorp/azuread provider version 3.9.0

This repo builds and publishes the [Terraform azuread provider](https://registry.terraform.io/providers/hashicorp/azuread/3.9.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform azuread provider](https://registry.terraform.io/providers/hashicorp/azuread/3.9.0)
