...
// https://registry.terraform.io/providers/hashicorp/azuread/3.9.0/docs/data-sources/domains
...
export class DataAzureadDomains extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzureadDomains that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/3.9.0/docs/data-sources/domains#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azuread/3.9.0/docs/data-sources/domains azuread_domains} Data Source
  *
  * @param scope The scope in which to define this construct
