...
// https://registry.terraform.io/providers/hashicorp/azuread/3.8.0/docs/resources/directory_role_assignment
...
export class DirectoryRoleAssignment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectoryRoleAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/3.8.0/docs/resources/directory_role_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azuread/3.8.0/docs/resources/directory_role_assignment azuread_directory_role_assignment} Resource
  *
  * @param scope The scope in which to define this construct
