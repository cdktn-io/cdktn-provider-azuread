...
// https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/resources/synchronization_secret
...
export class SynchronizationSecret extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SynchronizationSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/resources/synchronization_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/resources/synchronization_secret azuread_synchronization_secret} Resource
  *
  * @param scope The scope in which to define this construct
