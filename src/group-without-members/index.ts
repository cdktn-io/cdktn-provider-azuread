...
// https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/resources/group_without_members
...
export interface GroupWithoutMembersConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly dynamicMembership?: GroupWithoutMembersDynamicMembership;
  /**
  * timeouts block
  *
  ...
  */
  readonly timeouts?: GroupWithoutMembersTimeouts;
}
...
export class GroupWithoutMembersDynamicMembershipOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GroupWithoutMembersDynamicMembership | undefined {
  ...
  public set internalValue(value: GroupWithoutMembersDynamicMembership | undefined) {
    if (value === undefined) {
...
export interface GroupWithoutMembersTimeouts {
  /**
...
export class GroupWithoutMembers extends cdktn.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azuread_group_without_members";
  ...
  * @param importFromId The id of the existing GroupWithoutMembers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/resources/group_without_members#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/resources/group_without_members azuread_group_without_members} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GroupWithoutMembersConfig
  */
  public constructor(scope: Construct, id: string, config: GroupWithoutMembersConfig) {
    super(scope, id, {
      terraformResourceType: 'azuread_group_without_members',
  ...
  private _dynamicMembership = new GroupWithoutMembersDynamicMembershipOutputReference(this, "dynamic_membership");
  public get dynamicMembership() {
    return this._dynamicMembership;
  }
  public putDynamicMembership(value: GroupWithoutMembersDynamicMembership) {
  ...
  private _timeouts = new GroupWithoutMembersTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GroupWithoutMembersTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      dynamic_membership: {
        value: groupWithoutMembersDynamicMembershipToHclTerraform(this._dynamicMembership.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GroupWithoutMembersDynamicMembershipList",
      },
      timeouts: {
        value: groupWithoutMembersTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GroupWithoutMembersTimeouts",
      },
    };
