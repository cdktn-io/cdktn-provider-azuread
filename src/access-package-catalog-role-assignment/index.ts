...
// https://registry.terraform.io/providers/hashicorp/azuread/3.7.0/docs/resources/access_package_catalog_role_assignment
...
export class AccessPackageCatalogRoleAssignment extends cdktn.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azuread/3.7.0/docs/resources/access_package_catalog_role_assignment azuread_access_package_catalog_role_assignment} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: accessPackageCatalogRoleAssignmentTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AccessPackageCatalogRoleAssignmentTimeouts",
      },
    };
