...
// https://registry.terraform.io/providers/hashicorp/azuread/3.8.0/docs/resources/synchronization_job
...
export class SynchronizationJob extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SynchronizationJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/3.8.0/docs/resources/synchronization_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azuread/3.8.0/docs/resources/synchronization_job azuread_synchronization_job} Resource
  *
  * @param scope The scope in which to define this construct
