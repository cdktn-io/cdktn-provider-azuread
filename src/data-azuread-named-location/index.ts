...
// https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/data-sources/named_location
...
export class DataAzureadNamedLocationCountryOutputReference extends cdktn.ComplexObject {
...
export class DataAzureadNamedLocationCountryList extends cdktn.ComplexList {
...
export class DataAzureadNamedLocationIpOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzureadNamedLocationIpList extends cdktn.ComplexList {
...
export class DataAzureadNamedLocationTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzureadNamedLocationTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzureadNamedLocationTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataAzureadNamedLocation extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzureadNamedLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/data-sources/named_location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/data-sources/named_location azuread_named_location} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: dataAzureadNamedLocationTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataAzureadNamedLocationTimeouts",
      },
    };
