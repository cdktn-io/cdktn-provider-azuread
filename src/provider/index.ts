...
// https://registry.terraform.io/providers/hashicorp/azuread/3.8.0/docs
...
export class AzureadProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing AzureadProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/3.8.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azuread/3.8.0/docs azuread} Resource
  *
  * @param scope The scope in which to define this construct
