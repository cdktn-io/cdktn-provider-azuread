...
// https://registry.terraform.io/providers/hashicorp/azuread/3.8.0/docs/resources/synchronization_job_provision_on_demand
...
export class SynchronizationJobProvisionOnDemand extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SynchronizationJobProvisionOnDemand that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/3.8.0/docs/resources/synchronization_job_provision_on_demand#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azuread/3.8.0/docs/resources/synchronization_job_provision_on_demand azuread_synchronization_job_provision_on_demand} Resource
  *
  * @param scope The scope in which to define this construct
