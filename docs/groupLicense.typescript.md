...
```typescript
import { groupLicense } from '@cdktn/provider-azuread'

new groupLicense.GroupLicense(scope: Construct, id: string, config: GroupLicenseConfig)
```
...
```typescript
public putTimeouts(value: GroupLicenseTimeouts): void
```
...
groupLicense.GroupLicense.isConstruct(x: any)
```
...
groupLicense.GroupLicense.isTerraformElement(x: any)
```
...
groupLicense.GroupLicense.isTerraformResource(x: any)
```
...
groupLicense.GroupLicense.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.timeoutsInput">timeoutsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeouts">GroupLicenseTimeouts</a></code> | *No description.* |
...
```typescript
public readonly timeouts: GroupLicenseTimeoutsOutputReference;
```
...
```typescript
public readonly timeoutsInput: IResolvable | GroupLicenseTimeouts;
```
...
const groupLicenseConfig: groupLicense.GroupLicenseConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly timeouts: GroupLicenseTimeouts;
```
...
const groupLicenseTimeouts: groupLicense.GroupLicenseTimeouts = { ... }
```
...
new groupLicense.GroupLicenseTimeoutsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeoutsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeoutsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeouts">GroupLicenseTimeouts</a></code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | GroupLicenseTimeouts;
```
