...
```java
import io.cdktn.providers.azuread.group_license.GroupLicense;

GroupLicense.Builder.create(Construct scope, java.lang.String id)
...
//  .disabledPlans(java.util.List<java.lang.String>)
//  .id(java.lang.String)
...
| --- | --- | --- |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.scope">scope</a></code> | <code>software.constructs.Construct</code> | The scope in which to define this construct. |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.id">id</a></code> | <code>java.lang.String</code> | The scoped construct ID. |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.dependsOn">dependsOn</a></code> | <code>java.util.List<io.cdktn.cdktn.ITerraformDependable></code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.groupObjectId">groupObjectId</a></code> | <code>java.lang.String</code> | The object ID of the group to which the license should be assigned. |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.skuId">skuId</a></code> | <code>java.lang.String</code> | The unique identifier (GUID) for the SKU (license) to assign to the group. |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.disabledPlans">disabledPlans</a></code> | <code>java.util.List<java.lang.String></code> | A set of unique identifiers (GUIDs) for the service plans to disable for this license. |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.id">id</a></code> | <code>java.lang.String</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/resources/group_license#id GroupLicense#id}. |
...
##### `dependsOn`<sup>Optional</sup> <a name="dependsOn" id="@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.dependsOn"></a>

- *Type:* java.util.List<io.cdktn.cdktn.ITerraformDependable>

---

##### `forEach`<sup>Optional</sup> <a name="forEach" id="@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.forEach"></a>
...
##### `groupObjectId`<sup>Required</sup> <a name="groupObjectId" id="@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.groupObjectId"></a>
...
##### `skuId`<sup>Required</sup> <a name="skuId" id="@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.skuId"></a>
...
##### `disabledPlans`<sup>Optional</sup> <a name="disabledPlans" id="@cdktn/provider-azuread.groupLicense.GroupLicense.Initializer.parameter.disabledPlans"></a>
...
```java
public void putTimeouts(GroupLicenseTimeouts value)
```
...
```java
public void resetDisabledPlans()
```
...
GroupLicense.isConstruct(java.lang.Object x)
```
...
GroupLicense.isTerraformElement(java.lang.Object x)
```
...
GroupLicense.isTerraformResource(java.lang.Object x)
```
...
GroupLicense.generateConfigForImport(Construct scope, java.lang.String importToId, java.lang.String importFromId),GroupLicense.generateConfigForImport(Construct scope, java.lang.String importToId, java.lang.String importFromId, TerraformProvider provider)
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.node">node</a></code> | <code>software.constructs.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.cdktfStack">cdktfStack</a></code> | <code>io.cdktn.cdktn.TerraformStack</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.fqn">fqn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.friendlyUniqueId">friendlyUniqueId</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>java.util.Map<java.lang.String, java.lang.Object></code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.terraformResourceType">terraformResourceType</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>io.cdktn.cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.dependsOn">dependsOn</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.disabledPlansInput">disabledPlansInput</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.groupObjectIdInput">groupObjectIdInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.idInput">idInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.skuIdInput">skuIdInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.timeoutsInput">timeoutsInput</a></code> | <code>io.cdktn.cdktn.IResolvable\|<a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeouts">GroupLicenseTimeouts</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.disabledPlans">disabledPlans</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.groupObjectId">groupObjectId</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.id">id</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.skuId">skuId</a></code> | <code>java.lang.String</code> | *No description.* |
...
```java
public GroupLicenseTimeoutsOutputReference getTimeouts();
```
...
```java
public java.util.List<java.lang.String> getDisabledPlansInput();
```
...
```java
public java.lang.String getSkuIdInput();
```
...
```java
public IResolvable|GroupLicenseTimeouts getTimeoutsInput();
```

- *Type:* io.cdktn.cdktn.IResolvable|<a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeouts">GroupLicenseTimeouts</a>
...
```java
public java.util.List<java.lang.String> getDisabledPlans();
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicense.property.tfResourceType">tfResourceType</a></code> | <code>java.lang.String</code> | *No description.* |
...
```java
import io.cdktn.providers.azuread.group_license.GroupLicenseConfig;

GroupLicenseConfig.builder()
//  .connection(SSHProvisionerConnection|WinrmProvisionerConnection)
//  .count(java.lang.Number|TerraformCount)
//  .dependsOn(java.util.List<ITerraformDependable>)
//  .forEach(ITerraformIterator)
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseConfig.property.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseConfig.property.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseConfig.property.dependsOn">dependsOn</a></code> | <code>java.util.List<io.cdktn.cdktn.ITerraformDependable></code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseConfig.property.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseConfig.property.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseConfig.property.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseConfig.property.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseConfig.property.groupObjectId">groupObjectId</a></code> | <code>java.lang.String</code> | The object ID of the group to which the license should be assigned. |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseConfig.property.skuId">skuId</a></code> | <code>java.lang.String</code> | The unique identifier (GUID) for the SKU (license) to assign to the group. |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseConfig.property.disabledPlans">disabledPlans</a></code> | <code>java.util.List<java.lang.String></code> | A set of unique identifiers (GUIDs) for the service plans to disable for this license. |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseConfig.property.id">id</a></code> | <code>java.lang.String</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/resources/group_license#id GroupLicense#id}. |
...
```java
public GroupLicenseTimeouts getTimeouts();
```
...
```java
import io.cdktn.providers.azuread.group_license.GroupLicenseTimeouts;

GroupLicenseTimeouts.builder()
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeouts.property.create">create</a></code> | <code>java.lang.String</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/resources/group_license#create GroupLicense#create}. |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeouts.property.delete">delete</a></code> | <code>java.lang.String</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/resources/group_license#delete GroupLicense#delete}. |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeouts.property.read">read</a></code> | <code>java.lang.String</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/resources/group_license#read GroupLicense#read}. |
...
```java
import io.cdktn.providers.azuread.group_license.GroupLicenseTimeoutsOutputReference;

new GroupLicenseTimeoutsOutputReference(IInterpolatingParent terraformResource, java.lang.String terraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeoutsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>io.cdktn.cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeoutsOutputReference.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>java.lang.String</code> | The attribute on the parent resource this class is referencing. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeoutsOutputReference.property.creationStack">creationStack</a></code> | <code>java.util.List<java.lang.String></code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeoutsOutputReference.property.fqn">fqn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeoutsOutputReference.property.createInput">createInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeoutsOutputReference.property.deleteInput">deleteInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeoutsOutputReference.property.readInput">readInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeoutsOutputReference.property.create">create</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeoutsOutputReference.property.delete">delete</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeoutsOutputReference.property.read">read</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeoutsOutputReference.property.internalValue">internalValue</a></code> | <code>io.cdktn.cdktn.IResolvable\|<a href="#@cdktn/provider-azuread.groupLicense.GroupLicenseTimeouts">GroupLicenseTimeouts</a></code> | *No description.* |
...
```java
public IResolvable|GroupLicenseTimeouts getInternalValue();
```
