...
```go
import "github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v15/dataazureadgroups"
...
&dataazureadgroups.DataAzureadGroupsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v15.dataAzureadGroups.DataAzureadGroupsTimeouts,
}
```
