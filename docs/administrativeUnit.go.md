...
```go
import "github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v16/administrativeunit"
...
&administrativeunit.AdministrativeUnitConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v16.administrativeUnit.AdministrativeUnitTimeouts,
}
```
