...
```go
import "github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v17/administrativeunit"
...
&administrativeunit.AdministrativeUnitConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v17.administrativeUnit.AdministrativeUnitTimeouts,
}
```
