...
```go
import "github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v16/applicationpassword"
...
&applicationpassword.ApplicationPasswordAConfig {
	...
	StartDate: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v16.applicationPassword.ApplicationPasswordTimeouts,
}
```
