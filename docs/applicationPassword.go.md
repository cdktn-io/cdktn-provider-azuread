...
```go
import "github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v15/applicationpassword"
...
&applicationpassword.ApplicationPasswordAConfig {
	...
	StartDate: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v15.applicationPassword.ApplicationPasswordTimeouts,
}
```
