...
```go
import "github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v17/user"
...
&user.UserConfig {
	...
	Surname: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v17.user.UserTimeouts,
