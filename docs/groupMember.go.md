...
```go
import "github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v16/groupmember"
...
&groupmember.GroupMemberConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v16.groupMember.GroupMemberTimeouts,
}
```
...
| <code><a href="#@cdktn/provider-azuread.groupMember.GroupMemberConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/3.9.0/docs/resources/group_member#id GroupMember#id}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-azuread.groupMember.GroupMemberTimeouts.property.create">Create</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/3.9.0/docs/resources/group_member#create GroupMember#create}. |
| <code><a href="#@cdktn/provider-azuread.groupMember.GroupMemberTimeouts.property.delete">Delete</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/3.9.0/docs/resources/group_member#delete GroupMember#delete}. |
| <code><a href="#@cdktn/provider-azuread.groupMember.GroupMemberTimeouts.property.read">Read</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/3.9.0/docs/resources/group_member#read GroupMember#read}. |
